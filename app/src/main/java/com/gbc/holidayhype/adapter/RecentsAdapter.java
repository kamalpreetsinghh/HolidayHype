...
public class RecentsAdapter extends RecyclerView.Adapter<RecentsAdapter.RecentsViewHolder> {
    ...
    List<AttractionData> recentsDataList;

    public void setFilteredList(List<AttractionData> filteredList){
        this.recentsDataList = filteredList;
        notifyDataSetChanged();
    }


    public RecentsAdapter(Context context, ArrayList<AttractionData> recentsDataList) {
